...
describe("delete category", () => {
  ...
  it("should throw error when trying to delete a invalid category", async () => {
    const { token, deleteCategory } = await deleteCategoryBeforeEach();
  ...
  it("should throw error when trying to delete a category from a different user", async () => {
