...
describe("update task", () => {
  ...
  it("should throw error when trying to update an invalid task", async () => {
  ...
  it("should throw error when trying to update a task with invalid data types", async () => {
    const { token } = await updateTaskBeforeEach();
  ...
  it("should throw error when trying to update a task from a different user", async () => {
